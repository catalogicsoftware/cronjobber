...
import (
	...
	"github.com/hiddeco/cronjobber/controllers"
...
func init() {
	...
	utilruntime.Must(cronjobberv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	flag.IntVar(&numOfWorkers, "num-of-workers", 1, "The maximum number of workers")
	opts := zap.Options{
		Development: true,
	}
	...
	if err = (&controllers.TZCronJobReconciler{
		Client:                  mgr.GetClient(),
		Scheme:                  mgr.GetScheme(),
		MaxConcurrentReconciles: numOfWorkers,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TZCronJob")
		os.Exit(1)
	}
